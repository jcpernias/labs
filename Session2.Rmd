...
lab01 <- readSubjectsTables("./data/LA01.xls")
lab02 <- readSubjectsTables("./data/LA02.xls")
lab03 <- readSubjectsTables("./data/LA03.xls")
...
- Sustituyendo la curva de demanda en la expresión anterior:
  \[
    I_2(q_1, q_2) = \Big(500 - \frac{q_1}{2}  - \frac{q_2}{2}\Big) q_2
  \]
...
kable(ddply (T1_leader, .(Period), summTable, "Quantity"),
  digits = 1)      
...
kable(ddply (T1_follower, .(Period), summTable, "Quantity"),
  digits = 1)      
